...
export const ChapterList: React.FC<ChapterListProps> = ({ chapters, book }) => {
  console.log("ChapterList rendered with book:", book);
  console.log("ChapterList rendered with chapters:", chapters);
  return (
